...
const char* chatgpt_token = "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";
...
//StaticJsonDocument<384> doc; but esp32 got smaller stack than heap
...
if(strstr(chatgpt_Q, "who are you")){
  digitalWrite(led_3,HIGH);
  Serial.println("I am your A.I voice assistant.");
//  digitalWrite(15, LOW);
delay(1);
Serial2.println("I am your A.I voice assistant, and I enjoy helping you with your daily activites");
  digitalWrite(led_3,LOW);
...
//digitalWrite(uart_en,HIGH);
 ...
 else if(strstr(chatgpt_Q, "light on")==0 && strstr(chatgpt_Q, "light off") == 0 && strstr(chatgpt_Q, "blink on") ==0 && strstr(chatgpt_Q, "who are you") ==0){
